...
internal class MlKem512Benchmark {
    ...
    private data class Stats(
        ...
        val meanAlloc: Double
            get() = samples.map { it.allocBytes }.average()
    ...
    private fun measure(block: () -> Unit): Sample {
        ...
        val alloc = if (before >= 0 && after >= before) after - before else -1L
